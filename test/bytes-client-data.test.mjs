...
function validMetricsPayload() {
  return {
    ...
    metrics: {
      ...
      s1CitizensStaked: scalarMetric(1429, { classification: 'observed' }),
      s1CitizenV2Supply: scalarMetric(2036, { classification: 'observed' }),
      s1CollectionSupply: scalarMetric(2081, { classification: 'observed' }),
      s1StakedPercentage: scalarMetric(68.67, { classification: 'calculated' }),
      s2CitizensStaked: scalarMetric(1688, { classification: 'observed' }),
      s2CitizenV2Supply: scalarMetric(3581, { classification: 'observed' }),
      s2CollectionSupply: scalarMetric(3770, { classification: 'observed' }),
      s2StakedPercentage: scalarMetric(44.77, { classification: 'calculated' }),
      ethereumBytesHolderCount: scalarMetric(8145, { classification: 'observed' }),
      avalancheBytesHolderCount: scalarMetric(932, { classification: 'observed' }),
      crossChainUniqueBytesHolderCount: scalarMetric(8808, { classification: 'calculated' }),
