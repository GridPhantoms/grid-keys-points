    ...
    <main className="bytes-main">
        ...
        <div className="bytes-primary">
          ...
          <section className="bytes-human-section" aria-labelledby="plain-english-heading">
            ...
            <div className="bytes-human-grid">
              <article className="bytes-human-item bytes-human-item--participation">
              ...
              <article className="bytes-human-item bytes-human-item--distribution">
                <h3>Community Distribution</h3>
                <p>Distribution is another strength. Neo Tokyo&apos;s <a href="https://x.com/NeoTokyoCode/status/1916838058432848248" target="_blank" rel="noreferrer">official tokenomics</a> show BYTES was <strong>100% allocated to the community</strong>, with <a href="https://x.com/NeoTokyoCode/status/1915466651421626829" target="_blank" rel="noreferrer">no team allocation or VC unlocks</a>. The <a href="https://x.com/NeoTokyoCode/status/1451646106522243076" target="_blank" rel="noreferrer">original token was claimable only by full Citizens with Vault Cards</a>; today&apos;s configured BYTES 2.0 issuance flows through <a href="https://x.com/NeoTokyoCode/status/1915466654546329649" target="_blank" rel="noreferrer">staked S1 and S2 Citizens</a>. That makes BYTES <strong>community-held by design</strong>: supply entered through participation rather than an insider treasury or vesting schedule. Its 2021 origin was unusually fair and broadly distributed, and the model remains difficult to match.</p>
              </article>
              ...
              <article className="bytes-human-item bytes-human-item--context">
                ...
                <p>CoinMarketCap&apos;s ranked market snapshot places the <strong>$1 million market-cap line around rank 1,917</strong>. That is broad context rather than an official BYTES rank, but it shows that seven figures clears much of crypto&apos;s ranked long tail. Nearly five years after BYTES began, its first-party onchain market cap still sits around <strong>{totalSupplyValuation?.availability === 'available' && typeof totalSupplyValuation.value === 'number' ? `$${formatNumber(totalSupplyValuation.value / 1_000_000)} million` : 'an unavailable amount'}</strong>. It is not enormous by crypto standards. It is still here, still staked, and still economically meaningful.</p>
              </article>
            </div>
          </section>
        </div>
      ...
      <section className="bytes-footnotes" aria-labelledby="footnotes-heading">
        ...
        <ol>
          ...
          <li><strong>Market benchmark.</strong> <a href="https://coinmarketcap.com/all/views/all/" target="_blank" rel="noreferrer">CoinMarketCap&apos;s ranked all-coins view</a>, sorted by market cap, showed $1.00 million through rank 1,917 and $993,544.79 at rank 1,918 when checked on August 23, 2026. This cutoff is broad context only: the Terminal&apos;s first-party market cap is not an official BYTES rank or percentile on CoinMarketCap. CoinMarketCap&apos;s much larger tracked-token count includes assets without ranked market caps, so it is not used as the denominator.</li>
          ...
          <li><strong>Holder counting.</strong> Holder counts include addresses with positive chain-local balances. The weekly cross-chain total merges matching Ethereum and Avalanche addresses so each address is counted once. It does not identify beneficial owners or look through custodial wallets.</li>
          <li><strong>Citizen staking denominators.</strong> Citizen staking percentages divide live staked counts from the canonical V2 contracts by original collection supplies at the same Ethereum block: 2,081 S1 and 3,770 S2. Current assembled V2 supplies are dynamic and shown separately.</li>
          <li><strong>Not financial advice.</strong> This Terminal is provided for informational and educational purposes only. It is not financial, investment, legal, or tax advice, and nothing here is a recommendation to buy, sell, hold, or stake any asset. Verify the data independently and make decisions based on your own circumstances and risk tolerance.</li>
        </ol>
      </section>
    </main>
  );
