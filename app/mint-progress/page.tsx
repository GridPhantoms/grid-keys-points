      ...
      <nav className="border-b border-zinc-900 bg-zinc-950 py-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm">
            ...
            <Link href="/mint-progress" className="text-cyan-400 font-medium">Mint Progress</Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-zinc-950 border-t border-zinc-900 py-6">
            <div className="flex flex-col gap-6 px-6 text-lg">
              ...
              <Link href="/raffle" onClick={() => setMenuOpen(false)} className="hover:text-cyan-400">Raffle Tracker</Link>
              <Link href="/mint-progress" onClick={() => setMenuOpen(false)} className="text-cyan-400 font-medium">Mint Progress</Link>
            </div>
          </div>
        )}
      </nav>
