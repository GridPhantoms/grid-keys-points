...
export const UNVERIFIED_ETHEREUM_TOKEN_REASON = 'Canonical Ethereum BYTES token contract and ERC-20 interface have not been conclusively established.';
export const UNVERIFIED_PENDING_REWARDS_REASON = 'Aggregate claimable rewards methodology and indexer have not been independently verified.';
...
export function unverifiedEthereumTokenMetrics(asOf) {
  return {
    ethBytes2Supply: unavailableMetric(
      'BYTES',
      'observed',
      'canonical-source-not-established',
      asOf,
      UNVERIFIED_ETHEREUM_TOKEN_REASON,
    ),
    bytesHeldByStakingContract: unavailableMetric(
      'BYTES',
      'observed',
      'canonical-source-not-established',
      asOf,
...
export function pendingUnclaimedRewardsMetric(asOf) {
  return unavailableMetric(
    'BYTES',
    'observed',
    'aggregate-indexer-not-established',
    asOf,
    UNVERIFIED_PENDING_REWARDS_REASON,
  );
}
