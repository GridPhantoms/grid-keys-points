    ...
    <main className="bytes-main">
      ...
      <section className="bytes-footnotes" aria-labelledby="footnotes-heading">
        ...
        <ol>
          ...
          <li><strong>Market benchmark.</strong> <a href="https://coinmarketcap.com/all/views/all/" target="_blank" rel="noreferrer">CoinMarketCap&apos;s ranked all-coins view</a>, sorted by market cap, showed $1.00 million at ranks 1,861–1,863 and $999,513 at rank 1,864 when checked on August 16, 2026. This cutoff is broad context only: the Terminal&apos;s first-party market cap is not an official BYTES rank or percentile on CoinMarketCap. CoinMarketCap&apos;s much larger tracked-token count includes assets without ranked market caps, so it is not used as the denominator.</li>
